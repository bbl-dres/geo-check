/**
 * geometry.ts - Geometrie (GEO-001, GEO-002)
 *
 * Spatial accuracy and coordinate quality.
 * Compares SAP vs GWR values (GWR data populated via "GWR Daten aktualisieren").
 *
 * Error consolidation: If coordinates are missing (GEO-001),
 * do not also trigger GEO-002.
 *
 * Source of truth: docs/RULES.md §3.3
 */

import { registerRule } from "../engine/registry.ts";
import { haversineDistance } from "../geo/swisstopo.ts";
