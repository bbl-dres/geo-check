...
const translations = {
  ...
  de: {
    ...
    "batch.summary": "✓ {found} gefunden · ⚠ {notfound} nicht gefunden · ✕ {error} Fehler · {total} total",
    ...
    "batch.done.label": "Abfrage abgeschlossen – Ergebnisse unten.",
  ...
  fr: {
    ...
    "batch.summary": "✓ {found} trouvées · ⚠ {notfound} introuvables · ✕ {error} erreurs · {total} au total",
    ...
    "batch.done.label": "Requête terminée – résultats ci-dessous.",
  ...
  it: {
    ...
    "batch.summary": "✓ {found} trovati · ⚠ {notfound} non trovati · ✕ {error} errori · {total} totale",
    ...
    "batch.done.label": "Richiesta completata – risultati qui sotto.",
